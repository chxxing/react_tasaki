    ...
    return (
        <section className='MainVisual'>
                            ...
                            <figure key={slide.id} className={'itm0' + slide.id}>
                                <div className="container">
                                    <div className="inner">
                                        <h2>{slide.title}</h2>
                                        <p>{slide.des}</p>
                                        <a href={slide.link} className='more'>more <i className="bi-chevron-right"></i></a>
                                    </div>
                                </div>
                            </figure>
                        )
            ...
            <div className="slideArrows">
                <button onClick={() => MAIN.current.slickPrev()}><i className="bi-chevron-left"></i></button>
                <button onClick={() => MAIN.current.slickNext()}><i className="bi-chevron-right"></i></button>
            </div>
        </section>
    )
}
